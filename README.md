...
- **설계 장점**
	...
	- 타일의 **클래스에 따라 자동으로 타입/머티리얼/크기/회전 설정**이 이루어져 코드 유지보수가 용이합니다.
 	- 머티리얼 및 자원 설정은 모두 **TileDataAsset**을 통해 구성되어 있어, **블루프린트 기반 조정이 용이**합니다.
  	- 랜덤 머티리얼 및 회전을 통해 타일의 **시각적 반복을 줄이고 다양성**을 확보할 수 있습니다.

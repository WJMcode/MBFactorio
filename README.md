...
공유하는 규칙을 도입했습니다. 의미 있는 변수명과 함수 단위 주석 덕분에 팀원들이 제 코드를 쉽게 이해하며 작업할 수 있었고, "읽기 좋은 코드였다."는 피드백도 받을 수 있었습니다.

- **소통과 질문의 중요성 인식**  
모호한 부분은 빠르게 질문하고, 구현 의도를 주석으로 명확히 전달하려 노력했습니다.  
그 결과 팀원 간 이해가 빨라졌고, 마감 4일 전 핵심 기능을 안정적으로 마무리할 수 있었습니다.  
협업에서는 혼자 오래 고민하기보다 빠르게 공유하고 조율하는 것이 개발 속도와 완성도에 직접적인 영향을 준다는 걸  
느꼈습니다.
